...
7. Daggerheart Inspired System.
	...
	- Flow of Combat:
		...
		- On the players' turn, any player or friendly NPC can go in any order, including at the same time, **but the players must stick to that order after the first round**. If a player rolls with hope, that player gains a hope token, and the players continue their turns. If a player rolls with fear, after that player's turn, the DM can take a turn or gain one fear token. If the DM chooses to gain a fear token, the DM describes a small thing that causes it. For example, the enemy taunts the players.
...
5. DC20 Extras
	...
	- Modified DC20 Damage System for D&D
		- Instead of rolling for damage, you take the average amount of damage. If you pass the AC by 5 you do double damage. For each 5 above the AC, you do the average amount of damage times how many 5 above the AC you went. If you crit, you do max damage instead of the average damage.
